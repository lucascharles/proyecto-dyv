        ...
        <td width="40%">
            <table width="100%" align="center" border="0" cellpadding="5" cellspacing="5">    	
                ...
                <tr>
                    ...
                    <td><input type="text" grabar="S" name="txtcelular" id="txtcelular"  value="<? echo($objDeudor->get_data("celular")) ?>" size="25"  tipovalida="texto" class="input_form" onFocus="resaltar(this)" onBlur="noresaltar(this)"/><span id="msj_error_txtcelular" class="msjdato_incomp"></span></td>
                </tr>
                <tr>
                	<td class="etiqueta_form">Tel&eacute;fono</td>
                    <td><input type="text" grabar="S" name="txttelefono" id="txttelefono"  value="<? echo($objDeudor->get_data("telefono_fijo")) ?>" size="25"  tipovalida="texto" class="input_form" onFocus="resaltar(this)" onBlur="noresaltar(this)"/><span id="msj_error_txttelefono" class="msjdato_incomp"></span></td>
                </tr>
                <tr>
                	<td class="etiqueta_form">Email</td>
                    <td><input type="text" grabar="S" name="txtemail" id="txtemail" value="<? echo($objDeudor->get_data("email")) ?>"   size="25"  tipovalida="mail" class="input_form" onFocus="resaltar(this)" onBlur="noresaltar(this)"/><span id="msj_error_txtemail" class="msjdato_incomp"></span></td>
                </tr>
                <tr>
