...
<head>
    ...
    <script language="javascript"> 
		...
		{
			window.parent.quitarPermiso(id);
		}
...
<table width="100%" cellpadding="2" cellspacing="2" align="center" border="0" bgcolor="#FFFFFF">
	...
	<tr bgcolor="#FFFFFF" >
        ...
        <img src="images/asignar.gif" id="<? echo($datoTmp->get_data("id")) ?>" title="Quitar permiso" onclick="seleccionado(<? echo($datoTmp->get_data("id")) ?>)" style="cursor:pointer"  />
        </td>
