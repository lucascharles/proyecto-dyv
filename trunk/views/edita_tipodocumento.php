...
<input  type="hidden" name="id_tip_doc" id="id_tip_doc" value="<? echo($objTipDoc->get_data("id_tipo_documento")) ?>"/>
<div id="datos" style="">
<table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
    <tr>
		<td width="70" align="left">Descripci&oacute;n:</td>
        <td> &nbsp;&nbsp;&nbsp;<input type="text" name="txtdestipdoc" id="txtdestipdoc" value="<? echo($objTipDoc->get_data("tipo_documento")) ?>" size="40" onkeyup='mostrar(this)' valida="requerido" tipovalida="texto"/><span id="msj_error_txtdestipdoc" class="msjdato_incomp"></span></td>
        <td> </td>
    </tr>
    <tr>
        <td colspan="3">
