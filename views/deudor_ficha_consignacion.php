    	...
    	<td width="40%" valign="top">
        	<table cellpadding="0" cellspacing="2" border="0" align="center" width="100%">
            	<tr>
                    ...
                    <td align="left" ><input type="text" grabar="S" name="txtconsignacion" id="txtconsignacion" size="40" class="input_form_medio" onFocus="resaltar(this)" onBlur="noresaltar(this)" valida="requerido" tipovalida="texto" value="<? echo($consignacion_view) ?>"/></td>
                </tr>
                <tr>
					<td align="left" class="etiqueta_form">Abono 1</td>
                    <td align="left" ><input type="text" grabar="S" name="txtabono_1" id="txtabono_1" size="40" class="input_form" onFocus="resaltar(this)" onBlur="noresaltar(this)" valida="requerido" tipovalida="texto" value="<? echo($abono_1) ?>"/></td>
                </tr>
                <tr>
					<td align="left" class="etiqueta_form">Abono 2</td>
                      <td align="left" ><input type="text" grabar="S" name="txtabono_2" id="txtabono_2" size="40" class="input_form" onFocus="resaltar(this)" onBlur="noresaltar(this)" valida="requerido" tipovalida="texto" value="<? echo($abono_2) ?>"/></td>
                 </tr>   
                 <tr>
					<td align="left" class="etiqueta_form">Abono 3</td>
                    <td align="left" ><input type="text" grabar="S" name="txtabono_3" id="txtabono_3" size="40" class="input_form" onFocus="resaltar(this)" onBlur="noresaltar(this)" valida="requerido" tipovalida="texto" value="<? echo($abono_3) ?>"/></td>
                 </tr>
                 <tr>
					<td align="left" class="etiqueta_form">Abono 4</td>
                    <td align="left" ><input type="text" grabar="S" name="txtabono_4" id="txtabono_4" size="40" class="input_form_medio" onFocus="resaltar(this)" onBlur="noresaltar(this)" valida="requerido" tipovalida="texto" value="<? echo($abono_4) ?>"/></td>

                 </tr>
                 <tr>
					<td align="left" class="etiqueta_form">Pago Cliente</td>
                    <td align="left" ><input type="text" grabar="S" name="txtpago_cliente" id="txtpago_cliente" size="40" class="input_form" onFocus="resaltar(this)" onBlur="noresaltar(this)" valida="requerido" tipovalida="texto" value="<? echo($pago_cliente) ?>"/></td>
                  </tr>  
                  <tr>
					<td align="left" class="etiqueta_form">Giro Cheque 1</td>
                    <td align="left" ><input type="text" grabar="S" name="txtgiro_cheque_1" id="txtgiro_cheque_1" size="40" class="input_form" onFocus="resaltar(this)" onBlur="noresaltar(this)" valida="requerido" tipovalida="texto" value="<? echo($giro_cheque_1) ?>"/></td>
                 </tr>
                 <tr>
					<td align="left" class="etiqueta_form">Entrega Cheque</td>
                    <td align="left" ><input type="text" grabar="S" name="txtentrega_cheque" id="txtentrega_cheque" size="40" class="input_form_medio" onFocus="resaltar(this)" onBlur="noresaltar(this)" valida="requerido" tipovalida="texto" value="<? echo($entrega_cheque) ?>"/></td>

                 </tr>
                  <tr>
					<td align="left" class="etiqueta_form">Costas Procesales</td>
                    <td align="left" ><input type="text" grabar="S" name="txtcostas_procesales" id="txtcostas_procesales" size="40" class="input_form" onFocus="resaltar(this)" onBlur="noresaltar(this)" valida="requerido" tipovalida="texto" value="<? echo($costas_procesales) ?>"/></td>
                  </tr>  
                  <tr>
					<td align="left" class="etiqueta_form">Pago Costas</td>
                    <td align="left" ><input type="text" grabar="S" name="txtpago_costas" id="txtpago_costas" size="40" class="input_form" onFocus="resaltar(this)" onBlur="noresaltar(this)" valida="requerido" tipovalida="texto" value="<? echo($pago_costas) ?>"/></td>
                  </tr> 
                  <tr>
					<td align="left" class="etiqueta_form">Entrega cheque 1</td>
                    <td align="left" ><input type="text" grabar="S" name="txtentrega_cheque_1" id="txtentrega_cheque_1" size="40" class="input_form_medio" onFocus="resaltar(this)" onBlur="noresaltar(this)" valida="requerido" tipovalida="texto" value="<? echo($entrega_cheque_1) ?>"/></td>
                  </tr>  
                  <tr>
					<td align="left" class="etiqueta_form">Devoluci&oacute;n documento</td>
                    <td align="left" ><input type="text" grabar="S" name="txtdevolucion_documento" id="txtdevolucion_documento" size="40" class="input_form_medio" onFocus="resaltar(this)" onBlur="noresaltar(this)" valida="requerido" tipovalida="texto" value="<? echo($devolucion_documento) ?>"/></td>
                  </tr>  
                  <tr>
					<td align="left" class="etiqueta_form">Entrega documento</td>
                    <td align="left" ><input type="text" grabar="S" name="txtentrega_documento" id="txtentrega_documento" size="40" class="input_form_medio" onFocus="resaltar(this)" onBlur="noresaltar(this)" valida="requerido" tipovalida="texto" value="<? echo($entrega_documento) ?>"/></td>
                  </tr>
            	</table>
        </td>
        ...
        <td width="40%" valign="top"> 
        	<table cellpadding="0" cellspacing="2" border="0" align="center" width="100%"  style="position:relative; margin-left:5px;">
            	<tr>
                    ...
                    <td align="left" ><input type="text" grabar="S" name="txtmonto_consignacion" id="txtmonto_consignacion" size="40" class="input_form_medio" onFocus="resaltar(this)" onBlur="noresaltar(this)" valida="requerido" tipovalida="texto" value="<? echo($monto_consignacion) ?>"/></td>
                </tr>
                <tr>
					<td align="left" class="etiqueta_form">Monto 1</td>
                    <td align="left" ><input type="text" grabar="S" name="txtmonto_1" id="txtmonto_1" size="40" class="input_form" onFocus="resaltar(this)" onBlur="noresaltar(this)" valida="requerido" tipovalida="texto" value="<? echo($monto_1) ?>"/></td>
                </tr>
                <tr>
					<td align="left" class="etiqueta_form">Monto 2</td>
                      <td align="left" ><input type="text" grabar="S" name="txtmonto_2" id="txtmonto_2" size="40" class="input_form" onFocus="resaltar(this)" onBlur="noresaltar(this)" valida="requerido" tipovalida="texto" value="<? echo($monto_2) ?>"/></td>
                 </tr>   
                 <tr>
                 ...
                 <tr>
                    ...
                    <td align="left" ><input type="text" grabar="S" name="txtmonto_4" id="txtmonto_4" size="40" class="input_form_medio" onFocus="resaltar(this)" onBlur="noresaltar(this)" valida="requerido" tipovalida="texto" value="<? echo($monto_4) ?>"/></td>

                 </tr>
                 <tr>
					<td align="left" class="etiqueta_form">Pago DyV</td>
                    <td align="left" ><input type="text" grabar="S" name="txtpago_dyv" id="txtpago_dyv" size="40" class="input_form" onFocus="resaltar(this)" onBlur="noresaltar(this)" valida="requerido" tipovalida="texto" value="<? echo($pago_dyv) ?>"/></td>
                 </tr> 
                 <tr>
                  ...
                  <tr>
                    ...
                    <td align="left" ><input type="text" grabar="S" name="txtgiro_cheque_2" id="txtgiro_cheque_2" size="40" class="input_form" onFocus="resaltar(this)" onBlur="noresaltar(this)" valida="requerido" tipovalida="texto" value="<? echo($giro_cheque_2) ?>"/></td>
                  </tr> 
                  <tr>
                  ...
                  <tr>
                    ...
                    <td align="left" ><input type="text" grabar="S" name="txtrendicion_cliente" id="txtrendicion_cliente" size="40" class="input_form_medio" onFocus="resaltar(this)" onBlur="noresaltar(this)" valida="requerido" tipovalida="texto" value="<? echo($providencia_3) ?>"/></td>
                  </tr>                  
            	</table>
        </td>
        <td width="20%" valign="top"> 
			...
			?>
            	<tr>
                    ...
                    <td align="left" ><input type="text"  grabar="S" name="txtgasto_<? echo($datoTmp->get_data("id_gasto")) ?>" id="txtgasto_<? echo($datoTmp->get_data("gasto")) ?>" size="40" class="input_form_medio" onFocus="resaltar(this)" onBlur="noresaltar(this)" valida="requerido" tipovalida="texto" value="<? echo($datoTmp->get_data("importe")) ?>"/></td>
                    <td width="5"></td>
                </tr>
           <?
           }
